...
class FilterModule:
    ...
    def convert_mac_address(mac_address):
        ...
        A method to verify that the MAC address is in a valid format for Nautobot
    ...
    @staticmethod
    def compare_lists(device_serial_numbers, nautobot_serial_numbers):
        """
        A method to verify that the serial number(s) of a device/virtual chassis
        are in fact the same
        """
        device_serials_set = set(device_serial_numbers)
        nautobot_serials_set = set(nautobot_serial_numbers)

        return device_serials_set == nautobot_serials_set
    ...
    @staticmethod
    def get_interface_id(vm_name, nautobot_url, nautobot_headers):
        """Get an Interface ID from Nautobot
